...
namespace ContosoUniversity.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<ActionResult> Edit(int? id, byte[] rowVersion)
        {
            ...
            {
                Department deletedDpepartment = new Department();
                TryUpdateModel(deletedDpepartment, fieldsToBind);
                ModelState.AddModelError(string.Empty, "Unable to save changes. The department was deleted by another user.");
                ViewBag.InstructorID = new SelectList(db.Instructors, "ID", "FullName", deletedDpepartment);
                return View(deletedDpepartment);
            }
